...
public class NoteResource extends BaseResource implements Note {
  ...
  public PostNoteResponse postNote(org.putput.api.model.Note note) throws Exception {
    NoteEntity newNote = noteService.newNote(note.getShortText(), note.getContent());
  ...
  @Override
  public PutNoteByIdResponse putNoteById(String id, org.putput.api.model.Note entity) throws Exception {
    noteService.update(mapper.map(entity, NoteEntity.class));
